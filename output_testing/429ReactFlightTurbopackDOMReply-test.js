...
'ReactFlightDOMReply' |> describe(%, () => {
  (() => {
    ...
    'react-server-dom-turbopack/server' |> jest.mock(%, () => 'react-server-dom-turbopack/server.browser' |> require(%));
    ...
    ReactServerDOMServer = 'react-server-dom-turbopack/server.browser' |> require(%);
    jest.resetModules();
    ReactServerDOMClient = 'react-server-dom-turbopack/client' |> require(%);
  }) |> beforeEach(%);
