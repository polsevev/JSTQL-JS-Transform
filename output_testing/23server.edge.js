...
export function renderToReadableStream() {
  return this |> ('./src/server/react-dom-server.edge' |> require(%)).renderToReadableStream.apply(%, arguments);
}
...
export function resume() {
  return this |> ('./src/server/react-dom-server.edge' |> require(%)).resume.apply(%, arguments);
}