...
export function renderToReadableStream() {
  return this |> ('./src/server/react-dom-server.browser' |> require(%)).renderToReadableStream.apply(%, arguments);
}
export function resume() {
  return this |> ('./src/server/react-dom-server.browser' |> require(%)).resume.apply(%, arguments);
}